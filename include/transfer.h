...
/**
 * List of possible tracer populations.
 * */
enum tracer_type {euclid_galaxy, spherex_galaxy, astrophysical_gws};
...
#define _integrated_ncl_ (_index_tt_in_range_(ptr->index_tt_lensing, ptr->selection_num, ppt->has_cl_lensing_potential)) || \
...
#define _nonintegrated_ncl_ (_index_tt_in_range_(ptr->index_tt_density, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_density)) || \
...
#define _get_bin_integrated_ncl_(index_tt)                                                               \
      if (_index_tt_in_range_(ptr->index_tt_lensing, ptr->selection_num*ptr->selection_tracers_number, ppt->has_cl_lensing_potential)) \
        bin = (index_tt - ptr->index_tt_lensing) % ptr->selection_num;                                                          \
      if (_index_tt_in_range_(ptr->index_tt_nc_lens, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_lens))              \
        bin = (index_tt - ptr->index_tt_nc_lens) % ptr->selection_num;                                                          \
      if (_index_tt_in_range_(ptr->index_tt_nc_g4,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))                \
        bin = (index_tt - ptr->index_tt_nc_g4) % ptr->selection_num;                                                            \
      if (_index_tt_in_range_(ptr->index_tt_nc_g5,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))                \
        bin = (index_tt - ptr->index_tt_nc_g5) % ptr->selection_num;
/* macro: tracer number associated to particular redshift bin and selection function for non-integrated contributions*/
#define _get_tracer_nonintegrated_ncl_(index_tt)                                                      \
      if (_index_tt_in_range_(ptr->index_tt_density, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_density))     \
        tracer = (index_tt - ptr->index_tt_density) / ptr->selection_num;                                                    \
      if (_index_tt_in_range_(ptr->index_tt_rsd,     ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd))         \
        tracer = (index_tt - ptr->index_tt_rsd) / ptr->selection_num;                                                        \
      if (_index_tt_in_range_(ptr->index_tt_d0,      ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd))         \
        tracer = (index_tt - ptr->index_tt_d0) / ptr->selection_num;                                                         \
      if (_index_tt_in_range_(ptr->index_tt_d1,      ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_rsd))         \
        tracer = (index_tt - ptr->index_tt_d1) / ptr->selection_num;                                                         \
      if (_index_tt_in_range_(ptr->index_tt_nc_g1,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))          \
        tracer = (index_tt - ptr->index_tt_nc_g1) / ptr->selection_num;                                                      \
      if (_index_tt_in_range_(ptr->index_tt_nc_g2,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))          \
        tracer = (index_tt - ptr->index_tt_nc_g2) / ptr->selection_num;                                                      \
      if (_index_tt_in_range_(ptr->index_tt_nc_g3,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))          \
        tracer = (index_tt - ptr->index_tt_nc_g3) / ptr->selection_num;
/* macro: tracer number associated to particular redshift bin and selection function for integrated contributions*/
#define _get_tracer_integrated_ncl_(index_tt)                                                               \
      if (_index_tt_in_range_(ptr->index_tt_lensing, ptr->selection_num*ptr->selection_tracers_number, ppt->has_cl_lensing_potential)) \
        tracer = (index_tt - ptr->index_tt_lensing) / ptr->selection_num;                                                          \
      if (_index_tt_in_range_(ptr->index_tt_nc_lens, ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_lens))              \
        tracer = (index_tt - ptr->index_tt_nc_lens) / ptr->selection_num;                                                          \
      if (_index_tt_in_range_(ptr->index_tt_nc_g4,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))                \
        tracer = (index_tt - ptr->index_tt_nc_g4) / ptr->selection_num;                                                            \
      if (_index_tt_in_range_(ptr->index_tt_nc_g5,   ptr->selection_num*ptr->selection_tracers_number, ppt->has_nc_gr))                \
        tracer = (index_tt - ptr->index_tt_nc_g5) / ptr->selection_num;
/**
...
struct transfers {
  ...
  short selection_multitracing;          /**< deal with the multitracing option */
  int selection_tracers_number;          /**< number of tracers used */
  int selection_num;                     /**< number of redshift bins for number count \f$ C_l \f$'s */
  ...
  enum tracer_type selection_tracer_2;   /**< second tracer */
  
  short has_nz_file;       /**< Has dN/dz (selection function) input file? */
  FileName nz_file_name_1; /**< dN/dz (selection function) input file name for first tracer */
  int nz_size_1;           /**< number of redshift values in input tabulated selection function */
  double * nz_z_1;         /**< redshift values in input tabulated selection function */
  double * nz_nz_1;        /**< input tabulated values of selection function */
  double * nz_ddnz_1;      /**< second derivatives in splined selection function*/
  FileName nz_file_name_2; /**< dN/dz (selection function) input file name for second tracer */
  int nz_size_2;           /**< number of redshift values in input tabulated selection function */
  double * nz_z_2;         /**< redshift values in input tabulated selection function */
  double * nz_nz_2;        /**< input tabulated values of selection function */
  double * nz_ddnz_2;      /**< second derivatives in splined selection function*/

  short has_nz_evo_file;        /**< Has dN/dz (evolution function) input file? */
  FileName nz_evo_file_name_1;  /**< dN/dz (evolution function) input file name for first tracer */
  int nz_evo_size_1;            /**< number of redshift values in input tabulated evolution function */
  double * nz_evo_z_1;          /**< redshift values in input tabulated evolution function */
  double * nz_evo_nz_1;         /**< input tabulated values of evolution function */
  double * nz_evo_dlog_nz_1;    /**< log of tabulated values of evolution function */
  double * nz_evo_dd_dlog_nz_1; /**< second derivatives in splined log of evolution function */
  FileName nz_evo_file_name_2;  /**< dN/dz (evolution function) input file name for second tracer */
  int nz_evo_size_2;            /**< number of redshift values in input tabulated evolution function */
  double * nz_evo_z_2;          /**< redshift values in input tabulated evolution function */
  double * nz_evo_nz_2;         /**< input tabulated values of evolution function */
  double * nz_evo_dlog_nz_2;    /**< log of tabulated values of evolution function */
  double * nz_evo_dd_dlog_nz_2; /**< second derivatives in splined log of evolution function */
  
  double f_NL;     /**< primordial non-Gaussianity, amplitude */
  double n_NG;         /**< primordial non-Gaussianity, running */
  double k_pivot_NG;   /**< primordial non-Gaussianity, pivot scale */
  double delta_crit;     /**< critical threshold for spherical collapse */
